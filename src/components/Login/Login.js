...
const Login = (props) => {
  ...
  const emailChangeHandler = (event) => {
    ...
    setFormIsValid(
            event.target.value.includes('@') && enteredPassword.trim().length > 6 && enteredCollegeName.trim().length > 10
          );
  ...
  const passwordChangeHandler = (event) => {
    ...
    setFormIsValid(
             emailState.isValid && event.target.value.trim().length > 6 && enteredCollegeName.trim().length > 10
          );
  ...
  const collegenameChnageHandler = (event) => {
    ...
    setFormIsValid(
            emailState.isValid && enteredPassword.trim().length > 6 && event.target.value.trim().length > 10
           );
  }
